...
import com.udemy.webflux_playground.sec02.entity.CustomerOrder;
import com.udemy.webflux_playground.sec02.entity.Product;
...
public interface CustomerOrderRepository extends ReactiveCrudRepository<CustomerOrder, UUID> {
    ...
    @Query("""
            ...
            """)
    Flux<OrderDetails> getOrderDetailByProduct(String description);
